...
function Footer() {
    return (  
        <footer style={{backgroundColor:"rgb(240,240,240)"}}>
            <div className='conatainer border-top mt-5' >
                ...
                <div className='m-5 text-muted'style={{fontSize:"13px"}}>
                    ...
                    <a href=''className='text-muted p-2'style={{textDecoration:"none"}}>NSE</a>
                    <a href=''className='text-muted p-2'style={{textDecoration:"none"}}>BSE</a>
                    <a href=''className='text-muted p-2'style={{textDecoration:"none"}}>MCX</a>
                    <a href=''className='text-muted p-2'style={{textDecoration:"none"}}>Terms & conditions </a>
                    <a href=''className='text-muted p-2'style={{textDecoration:"none"}}>Policies & procedures</a>
                    <a href=''className='text-muted p-2'style={{textDecoration:"none"}}>Privacy policy </a>
                    <a href=''className='text-muted p-2'style={{textDecoration:"none"}}>Disclosure </a>
                    <a href=''className='text-muted p-2'style={{textDecoration:"none"}}>For investor's attention</a>
                    <a href=''className='text-muted p-2 'style={{textDecoration:"none"}}>Investor charter</a>
